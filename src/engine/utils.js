...
var Utils = {
  ...
  /**
   * Return a function that will call the specified method in a specific
   * context.
   *
   * @param function  The method that should be called by the returned
   *                  function.
  ...
  proxyMethodCall: function (method_name, instance_property) {
    return function () {
      if (!this[instance_property]
        || !this[instance_property][method_name]) {
        return false;
      }
